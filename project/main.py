# -*- coding: utf-8 -*-
"""
Created on Sun May 29 22:05:05 2022
...
decision_obj = decision_tree(pre_obj.x_train, pre_obj.x_test, pre_obj.y_train, pre_obj.y_test, "",[],[],0)
decision_obj.classification_decision()



svm_obj = support_vector_machine(pre_obj.x_train, pre_obj.x_test,pre_obj. y_train, pre_obj.y_test," ", [],[],0)
svm_obj.classification_svm()


logistic_obj=logistic__regression(pre_obj.x_train, pre_obj.x_test, pre_obj.y_train, pre_obj.y_test, "",[],[],0)
...
decision_obj1 = decision_tree(pre_obj1.x_train, pre_obj1.x_test, pre_obj1.y_train, pre_obj1.y_test, "",[],[],0)
decision_obj1.load_decision()

svm_obj1 = support_vector_machine(pre_obj1.x_train, pre_obj1.x_test,pre_obj1. y_train, pre_obj1.y_test," ", [],[],0)
svm_obj1.load_svm()


logistic_obj1=logistic__regression(pre_obj1.x_train, pre_obj1.x_test, pre_obj1.y_train, pre_obj1.y_test, "",[],[],0)
